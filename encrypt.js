...
const slides = [
  ...
  },
  {
    ...
    problem: `Although ride participants typically carry their phones with them on rollercoaster rides, a device that holds several powered-on phones at once is more likely to short circuit or produce an arc flash. At worst, the presence of a significant body of water (the Pacific Ocean) could risk electrical explosions.`,
    law: `The Division of Occupational Safety and Health (\u201cDOSH\u201d) regulates the electrical safety obligations for California amusement parks. Consistent with the cited device safety law, MSCHF and the SMP could face negligence claims arising from injuries caused by electrical failures in addition to a DOSH citation (and thus a potential device/ride shut-down).`,
    solution: `If MSCHF is responsible for electrical compliance, consider including an electrical compliance clause that clearly states the device complies with battery safety, water protection strategies, and a California-licensed PE sign-off. If SMP is responsible (since the electrical source is seemingly derived from the SMP\u2019s rollercoaster, itself), consider co-hiring a third-party electrical engineer to inspect the device and the ride for ongoing compliance.`,
    tag: 'Station 2',
    color: '#4ECDC4',
  },
  {
    ...
    problem: `The term sheet states that all IP \u201ccreated by MSCHF\u2026shall remain the sole property of MSCHF.\u201d Based on this language, one could imagine a dispute between a pier-goer who uses the Phone Coaster to create a video and MSCHF, who arguably co-\u201ccreated\u201d the IP by facilitating the entire process.`,
    law: `Joint authorship of copyrighted material typically requires intent from all parties. That said, the language in the term sheet is vague, and pier-goers may have a reasonable expectation of ownership over their recorded content. This may raise disputes over single ownership and produces an overall risk of doctrinal muddying.`,
  ...
  {
    type: 'issue',
    title: 'Issue 4: Privacy Concerns',
    problem: `If a participant\u2019s device captures other riders or bystanders, those people may raise privacy claims against MSCHF and the SMP for using their likeness for commercial purposes without consent. The term sheet specifically notes that MSCHF plans to use the recorded IP for \u201cmarketing\u201d and \u201cpromotion.\u201d`,
    ...
    solution: `Consider adopting GoPro\u2019s approach to ensure the camera is only a capture device and not infrastructure for (even unintended) surveillance: the contract prohibits the device company from designing any product version that requires a cloud upload or any other shared content storage. The agreement should also consider an automatic blurring of faces other than the device holder. Finally, at park entry, consider a general notice that photography and video technology is used throughout the park. This puts any unknowingly filmed guests on constructive notice. Any promotional videos using pier-goers\u2019 images would require separate and individual waivers.`,
    tag: 'Station 4',
    color: '#FF8C42',
  },
  {
    type: 'issue',
    title: 'Issue 5: Assumption of Risk',
    problem: `Given all of these concerns, the term sheet likely should include some kind of waiver or statement of a participant\u2019s assumption of the risk, which it does not.`,
    law: `California\u2019s assumption of the risk doctrine protects operators of inherently more dangerous or risky activities against negligence claims, when the activity makes the risk inherent. See <em>Knight v. Jewett</em>, 3 Cal. 4th 296, 316 (1992) (explaining that in certain circumstances, \u201cthe careless conduct of others is treated as an \u2018inherent risk\u2019 of a sport, thus barring recovery by the plaintiff.\u201d). The caveat here is that defendants still \u201chave a duty to use due care not to increase the risks to a participant over and above those inherent.\u201d <em>Id.</em>`,
    solution: `To ensure that the traditional assumption of the risk principles apply if, for example, a pier-goer\u2019s phone accidentally breaks while on the Phone Roller Coaster, the SMP should update its existing ride waiver (signed at the point of a park ticket purchase) to specifically include MSCHF\u2019s device and its risks. This update should also be reflected in the terms sheet, so that both partners are aware.`,
    tag: 'Station 5',
    color: '#F7DC6F',
  },
];
